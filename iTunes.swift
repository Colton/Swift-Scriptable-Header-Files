...
@objc protocol iTunesApplication {
	...
	optional func sources() -> SBElementArray<iTunesSource *>
...
// run iTunes
	optional func quit()
// quit iTunes
	optional func add(x: NSArray<NSURL *>, to: SBObject) -> iTunesTrack
...
@objc protocol iTunesSource: iTunesItem {
	...
	optional func playlists() -> SBElementArray<iTunesPlaylist *>
