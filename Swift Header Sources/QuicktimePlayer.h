...
- (QuicktimePlayerDocument *) newScreenRecording NS_RETURNS_NOT_RETAINED;  // Create a new screen recording document.
...
@interface QuicktimePlayerAudioCompressionPreset : SBObject <QuicktimePlayerGenericMethods>
...
@interface QuicktimePlayerMovieCompressionPreset : SBObject <QuicktimePlayerGenericMethods>
...
@interface QuicktimePlayerScreenCompressionPreset : SBObject <QuicktimePlayerGenericMethods>
